...
class LCBCodeGenerationBenchmark(AIPerfLoggerMixin):
    """Registered placeholder for a future LiveCodeBench code generation loader.
    ...
    async def load_problems(
        ...
        raise NotImplementedError(
            "lcb_codegeneration benchmark is not yet implemented; only 'mmlu' is available in this release."
        )
